<template>
  <el-dialog :visible.sync="box"
    ...
    <div class="avue-tip">
      ...
      <div class="item"
           v-if="['query', 'header', 'dataQuery', 'dataHeader'].includes(type)">
        <div class="header">
          参数说明
        </div>
        <div class="content"
      ...
      <div class="item"
           v-if="['labelFormatter', 'formatter'].includes(type)">
        <div class="header">
          参数说明
        </div>
        <div class="content"
