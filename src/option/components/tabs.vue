  ...
  <div>
    ...
    <template v-if="main.activeOption.type==='tabs'">
      <el-form-item label="排列">
        <avue-radio v-model="main.activeOption.orientList"
                    :dic="dicOption.orientList"></avue-radio>
      </el-form-item>
      ...
      <el-collapse accordion>
        ...
        <el-collapse-item title="高亮设置">
          ...
          <el-form-item label="背景颜色">
            <avue-input-color v-model="main.activeOption.empBackgroundColor"></avue-input-color>
          </el-form-item>
