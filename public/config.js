window.$website = {
  isDemo: false,
  isDemoTip: '演示环境不允许操作',
  title: 'iot-scada物联网组态系统',
  url: 'http://localhost:10002',
  iotUrl: '/iot',
  mqttUrl: 'wss://broker.javablade.com',
  autoSave: false,
  routers: {
    mainPath: '/'
  },
  autoSaveTime: 60000,
  clientOption: {
    clientId: 'avue-data', // 客户端id
    clientSecret: 'avue-data', // 客户端密钥
    accessToken: 'accessToken', // 接收传参的key
    authorization: 'Authorization', // token请求头的key
    tokenHeader: 'Blade-Auth',
    bearer: 'bearer', // jwt bearer
  },
  componentsList: [{
    name: 'test',
  ...
  baseList: [{
    ...
    children: [{
      ...
      option: {
        ...
        title: "语音播放",
        icon: 'icon-audio',
        img: 'img/assets/audio.png',
        dataType: 0,
        data: {
          value: 'avue-data宇宙超级无敌棒!!!'
        },
        dataFormatter: "",
        dataHeader: "",
        dataQuery: "",
      ...
      option: {
        ...
        dataType: 0,
        data: {
          value: 'https://node1.olelive.com:6443/live/CCTV9HD/hls.m3u8'
        },
        option: {
          autoplay: true
        },
    ...
    children: [{
      ...
      option: {
        ...
        option: {
          ...
          content: "<div style=\"font-family: YouSheBiaoTiHei; justify-content: center; color: rgb(85, 216, 255); font-size: 78px; filter: drop-shadow(rgb(2, 7, 24) 0px 4px 9px) drop-shadow(rgb(0, 183, 255) 0px 0px 18px);\">\n    <div style=\"writing-mode: horizontal-tb; word-spacing: 0px; letter-spacing: 4px; text-orientation: upright; color: transparent; background: linear-gradient(0deg, rgb(85, 216, 255) 0px, rgb(255, 255, 255) 100%) text; clip-path: inset(1px);\">\n        Avue-data 自定义 HTML\n    </div>\n</div>"
        }
      }
    }, {
      label: '定时器',
